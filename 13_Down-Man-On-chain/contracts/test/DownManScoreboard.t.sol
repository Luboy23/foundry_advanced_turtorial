...
/// @notice DownManScoreboard 合约测试（成功路径 + 失败路径 + 边界）
contract DownManScoreboardTest {
    Vm private constant vm =
        Vm(address(uint160(uint256(keccak256("hevm cheat code")))));

    DownManScoreboard private scoreboard;

    function setUp() public {
        scoreboard = new DownManScoreboard();
    }

    /// @notice 场景：分数为 0 时必须回滚
    function testSubmitScoreZeroReverts() public {
        vm.expectRevert(DownManScoreboard.ScoreMustBeGreaterThanZero.selector);
    ...
    function testLeaderboardSortAndReplacement() public {
        ...
        DownManScoreboard.ScoreEntry[] memory boardA = scoreboard.getLeaderboard();
        ...
        DownManScoreboard.ScoreEntry[] memory boardB = scoreboard.getLeaderboard();
    ...
    function testLeaderboardAllowsDuplicatePlayer() public {
        ...
        DownManScoreboard.ScoreEntry[] memory board = scoreboard.getLeaderboard();
    ...
    function testHistoryCapAndPagination() public {
        ...
        DownManScoreboard.ScoreEntry[] memory latest =
        ...
        DownManScoreboard.ScoreEntry[] memory oldest =
    ...
    function testFuzzHistoryPaginationBounds(uint256 seed) public {
        ...
        DownManScoreboard.ScoreEntry[] memory page =
    ...
    function _assertLeaderboardSorted(
        DownManScoreboard.ScoreEntry[] memory board
    ) internal pure {
    ...
    function _isOrdered(
        DownManScoreboard.ScoreEntry memory left,
        DownManScoreboard.ScoreEntry memory right
