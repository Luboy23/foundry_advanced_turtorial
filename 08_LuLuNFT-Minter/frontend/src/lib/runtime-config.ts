...
const envConfig: RuntimeConfig = {
  nftAddress: isAddress(process.env.NEXT_PUBLIC_NFT_ADDRESS)
    ? process.env.NEXT_PUBLIC_NFT_ADDRESS
    : ZERO_ADDRESS,
  marketAddress: isAddress(process.env.NEXT_PUBLIC_MARKET_ADDRESS)
...
export function getRuntimeConfig(): RuntimeConfig {
  ...
  return {
    nftAddress: isAddress(runtime.nftAddress)
      ? runtime.nftAddress
      : envConfig.nftAddress,
    marketAddress: isAddress(runtime.marketAddress)
      ? runtime.marketAddress
      : envConfig.marketAddress,
