...
const WINDOW_CONFIG_KEY = "__AIRDROP_RUNTIME_CONFIG__";
...
const normalizeRuntimeConfig = (
  ...
  airdropAddress: asAddress(runtimeConfig?.airdropAddress, ZERO_ADDRESS),
...
const getWindowRuntimeConfig = (): RuntimeContractConfigSource => {
  ...
  return normalizeRuntimeConfig({
    ...
    airdropAddress: objectValue.airdropAddress,
...
const resolveRuntimeConfigSnapshot = (): RuntimeContractConfig => {
  ...
  return normalizeRuntimeConfig({
    ...
    airdropAddress: windowConfig.airdropAddress ?? envConfig.airdropAddress,
...
export const getResolvedRuntimeConfig = () =>
