...
const WINDOW_CONFIG_KEY = "__FAUCET_RUNTIME_CONFIG__";
...
const normalizeRuntimeConfig = (
  ...
  faucetAddress: asAddress(runtimeConfig?.faucetAddress, ZERO_ADDRESS),
...
const getWindowRuntimeConfig = (): RuntimeContractConfigSource => {
  ...
  return normalizeRuntimeConfig({
    ...
    faucetAddress: objectValue.faucetAddress,
...
const resolveRuntimeConfigSnapshot = (): RuntimeContractConfig => {
  ...
  return normalizeRuntimeConfig({
    ...
    faucetAddress: windowConfig.faucetAddress ?? envConfig.faucetAddress,
